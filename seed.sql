...
INSERT OR IGNORE INTO news (title, content, category, priority, active) VALUES 
  ...
  ('Player Spotlight: Tomo Maric and Ivi Medukic Named Co-MVPs for their outstanding play', 'Congratulations to Ivan Kovač for outstanding performance this season.', 'player_highlight', 1, 1);
